...
#define DI_1 P2OUT|=BIT3
#define DI_0 P2OUT&=~BIT3
...
void main(void) {
	...
	while(1){
		    ...
		    LCD_P6x8Str(0,3,Temp_str);
		    if(Temp_str[0]=='3'&&Temp_str[1]=='5')buzzer();

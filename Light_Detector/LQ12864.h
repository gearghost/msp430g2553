...
#define DC_1 P2OUT|=BIT4
#define DC_0 P2OUT&=~BIT4

#define MOSI_1 P2OUT|=BIT5
#define MOSI_0 P2OUT&=~BIT5
...
const byte F6x8[][6] =
{
 ...
 void Display_NRF24L01(u32 data){
   LCD_P6x8Str(0,3,Int32ToStr(data,num32));
   NumArray_Clr(num32,10);
 }
